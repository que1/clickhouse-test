...
public class ClickHouseJDBCTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ClickHouseJDBCTest.class);

    private final static String JDBC_URL_FORMAT = "jdbc:clickhouse://%s:%d/%s?user=default&password=yiwen";
    ...
    public ClickHouseJDBCTest(String host, int port, String database) {
        this.jdbcUrl = String.format(JDBC_URL_FORMAT, host, port, database);
    ...
    public static void main(String[] args) {
        ClickHouseJDBCTest test = new ClickHouseJDBCTest("10.227.20.114", 8123, "test");
